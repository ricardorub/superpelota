...
public interface ReservaRepository extends JpaRepository<Reserva, Long> {
    ...
    @Query("SELECT r FROM Reserva r WHERE r.usuario = :usuario AND r.estado = :estado AND r.fechaHoraFin < :fechaHora")
List<Reserva> findByUsuarioAndEstadoAndFechaHoraFinBefore(
